...
import com.atguigu.springbootconfigautoconfig.mapper.DepartmentMapper;
...
public class DeptControoler {
    ...
    //整合mybatis 测试
    @ResponseBody
    @GetMapping("/depts/{id}")  //id以请求参数的方式传递
    public com.atguigu.springbootconfigautoconfig.bean.Department getDepartment(@PathVariable("id") Integer id) {
...
@ResponseBody
    @GetMapping("deptss")
    public com.atguigu.springbootconfigautoconfig.bean.Department insertDeptment(com.atguigu.springbootconfigautoconfig.bean.Department department) {
